...
class CodeGenerationVisitor : public ParseNodeIRVisitor {
 public:
  ...
  /// @brief Generate LLVM IR for a runtime error that will crash the user
  /// program if the code generated by this method is executed. This method
  /// inserts IR at whatever basic block is set as the insert point prior.
  /// @param message Message to be displayed describing the runtime error.
